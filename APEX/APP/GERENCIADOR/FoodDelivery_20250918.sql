...
--   Application:     275663
--   Name:            FoodDelivery
--   Date and Time:   17:01 Thursday September 18, 2025
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86580093405657217325)
,p_name=>'APP_PEDIDO_ID'
,p_item_sequence=>40
,p_item_default=>'select '''' from dual;'
,p_item_default_type=>'SQL_QUERY'
,p_prompt=>'App Pedido Id'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86580093515960217326)
,p_name=>'APP_CLIENTE_ID'
,p_item_sequence=>50
,p_item_default=>'select '''' from dual'
,p_item_default_type=>'SQL_QUERY'
,p_prompt=>'App Cliente Id'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>1609121967514267634
,p_item_template_options=>'#DEFAULT#'
